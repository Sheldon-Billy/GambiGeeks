...
// 🔥 Typing hook
const useTypedText = (texts, typingSpeed = 80, deletingSpeed = 15, pause = 1000) => {
    ...
    }, [displayedText, isDeleting, currentIndex, texts, typingSpeed, deletingSpeed, pause]);

    return displayedText;
};


const PictureZooming = () => {
    // const { scrollY } = useScroll();
    // const scale = useTransform(scrollY, [0, 1000], [1, 1.5]); // Zooms in as you scroll

    const texts = ["Hi 👋 ", "Start Now !", "Explore Now !", "Grow Now !", "@GambiGeeks"];
        ...
        < >
            <section id="home">
                ...
                <div className="relative h-screen w-full " >
                    ...
                    // src="https://img.freepik.com/free-vector/gradient-connection-background_23-2150462053.jpg"
                    // // src="https://img.freepik.com/free-vector/abstract-background-with-wireframe-design_1048-5743.jpg?semt=ais_hybrid&w=740"
                    // src="https://www.shutterstock.com/image-vector/abstract-highspeed-movement-background-dynamic-600nw-2511400131.jpg"
                ...
                /> */}
                    ...
                    <div className="absolute inset-0 px-6 text-white">
                        ...
                        <div className="fixed left-0 right-0 flex justify-between p-4 px-24 bg-black/60 backdrop-blur-md z-50">
                            ...
                            <div className="text-2xl font-bold mt-3 bg-gradient-to-r from-[#0800ff] via-[#ffffff] to-[#0000e3] text-transparent bg-clip-text ">GambiGeeks <span className="text-[blue]">LTD.</span>
                                <img src={Logo} className='h-36 rounded-[200px] w-36 absolute left-35 ' />
                            </div>
                            ...
                            <div className="text-[#cacaf3]  flex space-x-8 text-sm font-bold bg-gradient-to-t from-[#121289] via-[#000000] to-[black] px-3 py-2 rounded-[20px]">
                                <a href="#home" className='hover:text-[white] hover:underline '>
                                    <AiFillHome size={24} className='' /> Home</a>
                                <a href="#services" className='hover:text-[white] hover:underline '>
                                    <MdMiscellaneousServices size={24} className=' ' /> Services</a>
                                <a href="#clients" className='hover:text-[white] hover:underline'>
                                    <FaHandshake size={24} className='' /> Clients</a>
                                <a href="#" className='hover:text-[white] hover:underline'>
                                    <FaStar size={24} className='' />Reviews</a>
                                <a href="#" className='hover:text-[white] hover:underline'>
                                    <FaUsers size={24} className='' />Our Team</a>
                                <a href="#" className='hover:text-[white] hover:underline'>
                                    <MdContactPhone size={24} className='' />Get in touch</a>
                            </div>

                            <div>
                                <a href="#" className="font-semibold text-white hover:text-[green]" >Log In</a>
                        ...
                        <div className="flex ">
                            <div className='top-50  absolute mb-50 left-50 max-w-4xl justify-center items-center flex flex-col'>
                                <h1 className="text-6xl font-bold leading-tight text-center font-serif">
                                    ...
                                    The only tech Art you ever need. <br />
                                    <span className="bg-gradient-to-r from-[white] to-[blue] text-transparent bg-clip-text text-[40px]">
                                        {typedText}&nbsp;
                                    </span>
                                    <span className="animate-blink font-light text-[40px]">|</span>

                                </h1>
                                <p className="mt-4 text-lg md:text-xl font-light text-center">
                                    Empowering Inovation. Join us now, sky rocket your Tech abilities.<br /> Engineering your dreams
                                </p>
                            ...
                            <div className='absolute top-50 right-24 flex flex-col '>
                                ...
                                <button className='border-[blue] border rounded-[20px] p-1 w-50 shadow-[0_4px_10px_blue] absolute right-15 top-10 hover:scale-120 hover:shadow-[0_0_50px_blue] duration-100 '>Terms & Conditions</button>
                                ...
                                <button className='border-[blue] border rounded-[20px] p-1 w-50 shadow-[0_4px_10px_blue] absolute right-5 top-50 hover:scale-120 hover:shadow-[0_0_50px_blue]  duration-100'>Connect with us</button>
                ...
                <div className='h-screen items-center justify-center flex bg-black'>
                    <div >
                        <video
                            ...
                            muted
                            loop>
                            <source src="src/assets/_storage_emulated_0_Android_data_com.fawazapp.blackhole_files_DCIM_blackhole_BZPPKPZ4YIWZSN4ADHMF.mp4" type="video/mp4" />
